...
#include <specific_includes/linux/pkt_sched.h>
...
//#include <net/xfrm.h>
#include <specific_includes/net/netevent.h>
				...
				u8 tos, struct net_device *dev, int our)
{
	...
	LINUX_INIT_LIST_HEAD(&rth->rt_uncached);
	if (our) {
...
struct dst_entry *ipv4_blackhole_route(struct net *net, struct dst_entry *dst_orig)
{
	...
	if (rt) {
		...
		LINUX_INIT_LIST_HEAD(&rt->rt_uncached);
