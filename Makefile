...
-DMULTIPLE_MEM_ALLOC=0 -DOPTIMIZE_SENDPAGES -DOPTIMIZE_TCP_RECEIVE -DCONFIG_SYN_COOKIES -DIPAUGENBLICK_UDP_OPTIMIZATION -DOFFLOAD_NOT_YET

SHARED = libnetinet.so
