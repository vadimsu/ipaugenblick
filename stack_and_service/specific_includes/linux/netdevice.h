...
#include <specific_includes/uapi/linux/netdevice.h>
#include <rte_lcore.h>
...
#if defined(CONFIG_WLAN) || defined(CONFIG_AX25)
...
#if !defined(CONFIG_NET_IPIP) && !defined(CONFIG_NET_IPGRE) && \
    !defined(CONFIG_IPV6_SIT) && !defined(CONFIG_IPV6_TUNNEL)
...
{
	return read_pnet(&dev->nd_net)/*return &dev->nd_net*/;
}
...
#define for_each_netdev_in_bond_rcu(bond, slave)	\
		for_each_netdev_rcu(&init_net[rte_lcore_id()], slave)	\
