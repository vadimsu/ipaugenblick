...
#define MEMORY_FACTOR 1  /*8*/


#define NUMBER_OF_HEAD_SKBS 16384*8*MEMORY_FACTOR

#define NUMBER_OF_FCLONE_SKBS 16384*8*MEMORY_FACTOR
...
*/
#define MBUFS_PER_RX_QUEUE 4096*32*MEMORY_FACTOR

#define APP_MBUFS_POOL_SIZE 16384*8*MEMORY_FACTOR
