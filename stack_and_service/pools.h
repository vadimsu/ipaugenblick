...
#define NUMBER_OF_HEAD_SKBS 4096*1*MEMORY_FACTOR

#define NUMBER_OF_FCLONE_SKBS 4096*1*MEMORY_FACTOR
...
*/
#define MBUFS_PER_RX_QUEUE 4096*8*MEMORY_FACTOR

#define APP_MBUFS_POOL_SIZE 4096*1*MEMORY_FACTOR
