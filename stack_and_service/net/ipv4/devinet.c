...
#include <specific_includes/linux/if_addr.h>
...
#include <specific_includes/linux/netconf.h>
...
#include <specific_includes/net/addrconf.h>
...
static void inet_rcu_free_ifa(struct in_ifaddr *ifa/*struct rcu_head *head*/)
{
#if 0
