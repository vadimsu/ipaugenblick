...
cd ..
#rm -rf build 
make  CURRENT_DIR=$(pwd)/ clean RTE_SDK=$(pwd)/dpdk-16.07 LD_LIBRARY_PATH='stack_and_service/stack_and_service/x86_64-native-linuxapp-gcc/lib'
make CURRENT_DIR=$(pwd)/ RTE_SDK=$(pwd)/dpdk-16.07 LD_LIBRARY_PATH='stack_and_service/stack_and_service/x86_64-native-linuxapp-gcc/lib'
...
sudo cp dpdk-16.07/x86_64-native-linuxapp-gcc/lib/*.so /usr/lib/ipaugenblick/.
sudo cp dpdk-16.07/x86_64-native-linuxapp-gcc/lib/*.so.* /usr/lib/ipaugenblick/.
