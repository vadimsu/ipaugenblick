...
//#include <specific_includes/asm-generic/getorder.h>
#include <rte_config.h>
#include <rte_common.h>
#include <rte_malloc.h>
//#define KMALLOC_SHIFT_HIGH 32
...
//void kmem_cache_free(struct kmem_cache *cache, void *mem);
 ...
 */
void * __must_check __krealloc(void *, size_t, gfp_t);
void * __must_check krealloc(void *, size_t, gfp_t);
void kfree(void *);
void kzfree(void *);
...
#endif /* CONFIG_NUMA */
static inline int kmem_cache_get_free(void *cache)
{
